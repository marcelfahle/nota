...
import { Check, ChevronUp, Copy, ExternalLink, X } from "lucide-react";
...
export function StripeDevDock({ items }: { items: Array<StripeDockItem> }) {
      ...
      <div className="pointer-events-auto mx-auto max-w-6xl overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/96 text-zinc-100 shadow-2xl shadow-black/30 backdrop-blur">
        <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-3">
          <div className="min-w-0">
            ...
            <div className="mt-1 flex items-center gap-2">
              <p className="text-sm font-semibold">Resource Dock</p>
        ...
        {open ? (
          ...
          <div className="flex items-center justify-between gap-3 px-4 py-3 text-xs text-zinc-400">
            <p>
              Collapsed. Expand to inspect Stripe payment links, intent IDs, and recent invoice
              state.
            </p>
